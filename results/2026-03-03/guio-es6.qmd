---
title: "Busquedas programaticas en Interpro"
lang: es
date: today
execute: 
  output: false
...
language:
   title-block-published: "ultima actualizacion:"
...
taxosemproteinasaignadas <- taxot - taxo
```
...
*zinc finger, C2HC type* (Pfam )?
:::
```{r}
crocodilo <- fromJSON(paste0(API, 'protein/taxonomy/uniprot/8493/entry/pfam/PF01530'))
crocodilo
